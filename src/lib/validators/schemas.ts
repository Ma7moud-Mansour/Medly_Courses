...
export const adminCourseSchema = z.object({
  title: z.string().trim().min(2, "اكتب اسم الكورس."),
  ...
  description: z.string().trim().min(1, "اكتب وصف الكورس."),
  descriptionEn: z.string().optional().or(z.literal("")),
  thumbnail: z.string().trim().min(1, "ارفع صورة الكورس قبل الحفظ."),
  price: z.coerce.number().min(0, "اكتب سعر صحيح."),
  discountPrice: z.coerce.number().min(0).optional(),
  categoryId: z.string().min(1, "اختار التصنيف."),
  instructorId: z.string().min(1, "اختار الدكتور."),
